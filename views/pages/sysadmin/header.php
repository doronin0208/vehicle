  ...
  <body id="top">
    <div class="full-content">
      <div class="wrapper topbar">
        <div id="topbar" class="hoc clear sysadmin_topbar">
          <div class="fl_left">
            <div class="sysadmin_logo">
              <img id="admin_logo" class="logo" src="views/images/logo.png" alt="sysadmin_logo" />
            </div>
          </div>
          <div class="fl_right">
            <ul class="nospace">
              <li>
                <div class="topbar_date_box">
                  <h5 id = "time" class="topbar_date">00:00</h5>
                  <h5 id = "date" class="topbar_date">piątek 1.4.2022</h5>
                </div>
              </li>
              <li>
                <h3 class="topbar_username"><?php echo $_SESSION['user_fullname'] ?></h3>
              </li>
              <li>
                <div class="user_box">
